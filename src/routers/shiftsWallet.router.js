...
import { getSW,getIdSW,createSW,deleteSW } from "../controllers/shiftsWallet.controller.js";
...
export default class ShiftsWalletRouter extends AppRouter{
    init(){
        ...
        this.get("/:swid",handlePolicies(["USER", "PREMIUM", "COLLECTOR"]), getIdSW) //shiftswallet ID. solo user, premium y collector traen sus propias sw
